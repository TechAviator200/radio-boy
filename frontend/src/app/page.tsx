...
export default function Page() {
  const agent = {
    id: "radioboy",
    name: "Radio Boy",
    tagline: "Late-night DJ meets studio producer.",
    title: "Radio Boy",
    description: "Late-night DJ meets studio producer.",
    tags: ["AI", "Audio", "Voice"],
    bullets: [
      "AI-powered radio DJ companion",
      "Voice synthesis and audio production",
      "Real-time music recommendations",
    ],
    architecture: "Next.js + AI Voice API + Audio Processing",
    demoUrl: "#",
  };
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-8">
              ...
              <ul className="mt-4 space-y-3">
                {agent.bullets.map((bullet: string) => (
